...
def pagina_meli_cedi_oviedo(feria_mode=False, calle74=False):
    ...
    **Nota técnica:** El nuevo formato incluye la columna
    ...
    """)
                    ...
                    # Permitir NaNs y manejar strings como '-' convirtiéndolos numéricamente forzando errores a NaN
                    ...
                    st.download_button(label="⬇️ Descargar MELI modificado",
                                      data=output,
                                      file_name="MELI_CEDI_OVIEDO_ACTUALIZADO.xlsx",
...
def pagina_meli_av19_bulevar_oviedo(feria_mode=False, calle74=False):
    ...
    uploaded_file_erp = st.file_uploader("🧾 Cargar archivo CSV de ERP", type=['csv'], key="meli_av19_erp")
    ...
    **Nota técnica:** El nuevo formato incluye la columna
    ...
    """)
                    ...
                    st.download_button(label="⬇️ Descargar MELI modificado",
                                      data=output,
                                      file_name="MELI_AV19_BLV_OVI_ACTUALIZADO.xlsx",
                                      mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
                except Exception as e:
                    st.error(f"❌ Error al procesar: {e}")
